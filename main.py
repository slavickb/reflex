...
class MainApp:
    ...
    def konec(self, event=None) -> None:
    ...
    class Reflex:
        ...
        def __init__(self, window):
            ...
            self.start_radek = int(3+(self.pocet_tlacitek/self.tlacitka_strana))

            self.cas_ukazatel_data = tk.StringVar(self.window,
                                                  f"Poslední čas: {conf.posledni_cas} ms")
        ...
        def jadro(self, event=None) -> None:
            if (conf.spusteno is False):
                conf.spusteno = True
    ...
    class Numpad(Reflex):
        ...
        def __init__(self, window):
            ...
            self.text_okna = tk.Label(self.window,
                                      ...
                                      "či mačkat příslušná tlačítka na klávesnici\n"
                                      "Mezerníkem spustíte hru")
            self.text_okna.grid(row=1,
                                columnspan=self.tlacitka_strana,
                                column=1)
